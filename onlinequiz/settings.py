...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'x22212051@student.ncirl.ie' # this email will be used to send emails
...
EMAIL_RECEIVING_USER = ['x22212051@student.ncirl.ie'] # email on which you will receive messages sent from website
